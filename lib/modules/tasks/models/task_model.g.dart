...
const TaskSchema = CollectionSchema(
  ...
  properties: {
    r'category': PropertySchema(
      ...
      name: r'category',
      type: IsarType.byte,
      enumMap: _TaskcategoryEnumValueMap,
    ),
...
Task _taskDeserialize(
  ...
  final object = Task();
  object.category =
      _TaskcategoryValueEnumMap[reader.readByteOrNull(offsets[0])] ??
          TaskCategory.work;
  ...
  object.priority =
      _TaskpriorityValueEnumMap[reader.readByteOrNull(offsets[6])] ??
          TaskPriority.low;
  object.recurrenceRule = reader.readStringOrNull(offsets[7]);
  ...
  object.subtasks = reader.readStringList(offsets[11]) ?? [];
...
P _taskDeserializeProp<P>(
  ...
  switch (propertyId) {
    case 0:
      return (_TaskcategoryValueEnumMap[reader.readByteOrNull(offset)] ??
...
const _TaskcategoryEnumValueMap = {
  'work': 0,
  'personal': 1,
  'health': 2,
  'education': 3,
};
const _TaskcategoryValueEnumMap = {
  0: TaskCategory.work,
  1: TaskCategory.personal,
  2: TaskCategory.health,
  3: TaskCategory.education,
};
...
extension TaskQueryFilter on QueryBuilder<Task, Task, QFilterCondition> {
  ...
  QueryBuilder<Task, Task, QAfterFilterCondition> subtasksElementEqualTo(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Task, Task, QAfterFilterCondition> subtasksElementGreaterThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Task, Task, QAfterFilterCondition> subtasksElementLessThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Task, Task, QAfterFilterCondition> subtasksElementBetween(
    String lower,
    String upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Task, Task, QAfterFilterCondition> subtasksElementStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Task, Task, QAfterFilterCondition> subtasksElementEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Task, Task, QAfterFilterCondition> subtasksElementContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.contains(
  ...
  QueryBuilder<Task, Task, QAfterFilterCondition> subtasksElementMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
  ...
  QueryBuilder<Task, Task, QAfterFilterCondition> subtasksElementIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'subtasks',
        value: '',
  ...
  QueryBuilder<Task, Task, QAfterFilterCondition> subtasksElementIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.greaterThan(
        property: r'subtasks',
        value: '',
...
extension TaskQueryWhereDistinct on QueryBuilder<Task, Task, QDistinct> {
  ...
  QueryBuilder<Task, Task, QDistinct> distinctBySubtasks() {
    return QueryBuilder.apply(this, (query) {
...
extension TaskQueryProperty on QueryBuilder<Task, Task, QQueryProperty> {
  ...
  QueryBuilder<Task, TaskCategory, QQueryOperations> categoryProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Task, List<String>, QQueryOperations> subtasksProperty() {
    return QueryBuilder.apply(this, (query) {
