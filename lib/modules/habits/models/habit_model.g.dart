...
void _habitSerialize(
  ...
  writer.writeLongList(offsets[5], object.daysOfWeek);
...
Habit _habitDeserialize(
  ...
  object.daysOfWeek = reader.readLongList(offsets[5]) ?? [];
  object.description = reader.readStringOrNull(offsets[6]);
  object.frequency =
      _HabitfrequencyValueEnumMap[reader.readByteOrNull(offsets[7])] ??
...
extension HabitQueryFilter on QueryBuilder<Habit, Habit, QFilterCondition> {
  ...
  QueryBuilder<Habit, Habit, QAfterFilterCondition> daysOfWeekElementEqualTo(
      int value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
  ...
  QueryBuilder<Habit, Habit, QAfterFilterCondition> daysOfWeekElementLessThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Habit, Habit, QAfterFilterCondition> daysOfWeekElementBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Habit, Habit, QAfterFilterCondition> daysOfWeekLengthEqualTo(
      int length) {
    return QueryBuilder.apply(this, (query) {
      return query.listLength(
        r'daysOfWeek',
  ...
  QueryBuilder<Habit, Habit, QAfterFilterCondition> daysOfWeekIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.listLength(
        r'daysOfWeek',
        0,
  ...
  QueryBuilder<Habit, Habit, QAfterFilterCondition> daysOfWeekIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.listLength(
        r'daysOfWeek',
        0,
  ...
  QueryBuilder<Habit, Habit, QAfterFilterCondition> daysOfWeekLengthLessThan(
    int length, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Habit, Habit, QAfterFilterCondition> daysOfWeekLengthGreaterThan(
    int length, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Habit, Habit, QAfterFilterCondition> daysOfWeekLengthBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension HabitQueryWhereDistinct on QueryBuilder<Habit, Habit, QDistinct> {
  ...
  QueryBuilder<Habit, Habit, QDistinct> distinctByDaysOfWeek() {
    return QueryBuilder.apply(this, (query) {
...
extension HabitQueryProperty on QueryBuilder<Habit, Habit, QQueryProperty> {
  ...
  QueryBuilder<Habit, List<int>, QQueryOperations> daysOfWeekProperty() {
    return QueryBuilder.apply(this, (query) {
